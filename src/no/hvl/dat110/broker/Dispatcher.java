...
public class Dispatcher extends Stopable {
	...
	public void onConnect(ConnectMsg msg, Connection connection) {
		...
		// task E, send buffered messages if reconnect
		if (storage.buffer.containsKey(user)) {
			for (Message m : storage.getMessages(user)) {
	...
	public void onPublish(PublishMsg msg) {
		...
		for (String u : users) {
			if (!storage.clients.containsKey(u)) {
				storage.addBufferMessage(u, msg); // task E, user is disconnected
			} else {
